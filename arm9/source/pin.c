...
bool verifyPin(u32 pinMode)
{
    ...
    drawString(true, 10, 10 + SPACING_Y, COLOR_TITLE, "Premi START per spegnere, SELECT per cancellare");

    drawFormattedString(true, 10, 10 + 3 * SPACING_Y, COLOR_WHITE, "PIN (%u cifre): ", lengthBlock[0]);
